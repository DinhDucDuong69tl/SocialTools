...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Social Tools : Payment Admin Template</title>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.php" class="brand-logo">
				<img src="../img/logo7.png" alt="" viewbox="0 0 0 0"  width="60" height="100" >
				<img src="../img/logo8.png" alt=""  class="brand-title" width="135" height="60" margin="0px" >					
            </a>
				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						...
						<div class="dropdown-menu dropdown-menu-end">
							<a href="index.php?act=profile" class="dropdown-item ai-icon">
								<svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
								<span class="ms-2">Profile </span>
							</a>
							<a href="../Authenator/logout.php" class="dropdown-item ai-icon">
